    ...
    public static class PrototypeCurriculum
    {
        ...
        private static readonly FloorPlan[] _tenFloors =
        {
            new FloorPlan
            {
                ...
                RequiredPower = 215f, Spins = 5, SymbolPool = SoulAndAbsorber,
            ...
            new FloorPlan
            {
                ...
                RequiredPower = 445f, Spins = 5, SymbolPool = SoulAndAbsorber,
                ContractChoices = Array.Empty<ResistanceContract>(),
            ...
            new FloorPlan
            {
                ...
                RequiredPower = 565f, Spins = 5, SymbolPool = SoulAndAbsorber,
            ...
            new FloorPlan
            {
                ...
                RequiredPower = 395f, Spins = 5, SymbolPool = SoulAndAbsorber,
                ContractChoices = Array.Empty<ResistanceContract>(),
            ...
            new FloorPlan
            {
                ...
                RequiredPower = 580f, Spins = 5, SymbolPool = FullPool,
            ...
            new FloorPlan
            {
                ...
                // 하나뿐이라 비교가 성립하지 않았다.
                RequiredPower = 820f, Spins = 5, SymbolPool = FullPool,
            ...
            new FloorPlan
            {
                ...
                RequiredPower = 1460f, Spins = 5, SymbolPool = FullPool,
                ContractChoices = new[] { ResistanceContract.None, AbsorberContract, ProliferatorContract },
            ...
            new FloorPlan
            {
                ...
                RequiredPower = 1160f, Spins = 5, SymbolPool = FullPool,
