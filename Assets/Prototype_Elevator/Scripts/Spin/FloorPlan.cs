    ...
    public static class PrototypeCurriculum
    {
        ...
        private static readonly FloorPlan[] _tenFloors =
        {
            ...
            new FloorPlan
            {
                ...
                RequiredPower = 585f, Spins = 5, SymbolPool = SoulAndAbsorber,
                ContractChoices = Array.Empty<ResistanceContract>(),
            ...
            new FloorPlan
            {
                ...
                RequiredPower = 630f, Spins = 5, SymbolPool = SoulAndAbsorber,
            ...
            new FloorPlan
            {
                ...
                RequiredPower = 290f, Spins = 5, SymbolPool = SoulAndAbsorber,
                ContractChoices = Array.Empty<ResistanceContract>(),
            ...
            new FloorPlan
            {
                ...
                RequiredPower = 570f, Spins = 5, SymbolPool = FullPool,
            ...
            new FloorPlan
            {
                ...
                RequiredPower = 575f, Spins = 5, SymbolPool = FullPool,
                ContractChoices = new[] { ResistanceContract.None, AbsorberContract, ProliferatorContract },
            ...
            new FloorPlan
            {
                ...
                RequiredPower = 640f, Spins = 5, SymbolPool = FullPool,
                ContractChoices = new[] { ResistanceContract.None, AbsorberContract, ProliferatorContract },
            ...
            new FloorPlan
            {
                ...
                RequiredPower = 835f, Spins = 5, SymbolPool = FullPool,
